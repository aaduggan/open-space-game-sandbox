...
* [How can I help document things?](#how-to-submit-documentation)

# Introduction
Thank you for taking a look at open-space-game.  With the help of potential contributors, like you, we hope to make this one of the best SIM-RTS-RPG-FPS ... games out there.
...
3. Check back to see the answer to your question
	* Keep in mind that everyone here does so out of their free time and there may be gaps of time when responses are slow.   Feel free to set the notification settings for the question so you'll know immediately when its answered.
...
# Quality Controller<a id="quality-controller"></a><sup>[^^](#quick-start)</sup>
